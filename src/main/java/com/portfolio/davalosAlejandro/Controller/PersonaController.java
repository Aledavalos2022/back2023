...
import com.portfolio.davalosAlejandro.Dto.dtoPersona;
import com.portfolio.davalosAlejandro.Security.Controller.Mensaje;
import com.portfolio.davalosAlejandro.Service.ImpPersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersona dtopersona){
        ...
        Persona persona = new Persona(
                dtopersona.getNombre(), dtopersona.getApellido(), dtopersona.getAbout(), dtopersona.getTitulo(), dtopersona.getImg()
            );
